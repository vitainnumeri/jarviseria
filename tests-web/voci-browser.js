// Copia delle voci sintetiche utilizzabile dentro la pagina (nessun import).
...
function voce(f0, formanti, secondi, ampiezza = 0.25, seme = 1) {
...
const parla = (persona, secondi = 3, seme = 1, ampiezza = 0.25) =>
  voce(PERSONE[persona].f0, PERSONE[persona].formanti, secondi, ampiezza, seme);

const silenzio = (secondi) => new Float32Array(Math.floor(secondi * SR));

window.__voci = { parla, voce, PERSONE, SR, silenzio };
